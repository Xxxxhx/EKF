...
% open video writer
%v = VideoWriter('EKF_SLAM.mp4','MPEG-4');
%v.Quality = 65;
%open(v);
...
landmarks = read_world('C:\Users\Huang Xu\OneDrive\Intelligence Robots\HW10\EKF_Localization_framework\data\world.dat');
% load landmarks;
% Read sensor readings, i.e. odometry and range-bearing sensor
data = read_data('C:\Users\Huang Xu\OneDrive\Intelligence Robots\HW10\EKF_Localization_framework\data\sensor_data.dat');
%load data;
